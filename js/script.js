...
function generateRandoms() {
    a = Math.round(Math.random() * (reelOneOutcome.length-1));
    console.log(a);
    b = Math.round(Math.random() * (reelTwoOutcome.length-1));
    console.log(b);
    c = Math.round(Math.random() * (reelThreeOutcome.length-1));
    console.log(c);
}
...
function reset() {
    document.getElementById("reel-one").style.animation = "reset";
    document.getElementById("reel-two").style.animation = "reset";
    document.getElementById("reel-three").style.animation = "reset";
    winnings = 0;
}
